...
<div class="content">
    ...
    <div class="table-responsive p-2">
        <a href="tambah/tambahtugas.php" style="color:black;">
                ...
                <table class="table table-striped table-bordered pt-3 pb-3" id="datatablestugasopen">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <td>
                        <a href="ubah/ubahdatatugas.php?id_tugas=<?= $tugas["id_tugas"]; ?>">
