...
<div class="content">
    ...
    <a href="tambah/tambahtugas.php" style="color:black;">
            ...
            <table class="table table-striped table-bordered pt-3 pb-3" id="datatablestugasselesai">
            <thead>
                <tr>
                ...
                <td>
                    <form action="tambah/tambahnilai.php?id_tugas=<?= $tugas["id_tugas"]; ?>" method="POST">
                        <input type="hidden" name="id_tugas" value="<?= $tugas["id_tugas"]; ?>">
                        <button type="submit" name="apply" style="border:none; background:none; font-size: 20px; float: left;">
                            <i class="fa-solid fa-check" style="color:black;"></i>
                        </button>
                    </form>
                    <form action="hapus/hapusnilai.php?id_tugas=<?= $tugas["id_tugas"]; ?>" method="POST">
                        <input type="hidden" name="id_tugas" value="<?= $tugas["id_tugas"]; ?>">
                        <button type="submit" name="decline" style="border:none; background:none; font-size: 20px;">
