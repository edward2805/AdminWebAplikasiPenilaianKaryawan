        ...
        <div class="form-group" style="margin-top: 10px;">
            <label for="nohp">No Handphone</label>
                <div class="input-group">
                    ...
                    <input id="nohp" type="number" name="no_tlp" class="form-control" placeholder="Masukkan No Handphone" required>
                </div> 
        </div>

        <button type="submit" class="btn btn-primary mt-3" name="tambah" style="float: left;">Tambah Karyawan</button>
